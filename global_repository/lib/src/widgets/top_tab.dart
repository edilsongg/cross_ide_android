...
class _TopTabState extends State<TopTab> with SingleTickerProviderStateMixin {
  ...
  void listenOpenPage() {
    offset = Tween<double>(
            begin: offset.value,
            end: (tabWidth + 10.w) * tabController.pageindex)
        .animate(controller);
    controller.reset();
    controller.forward();
  }
  ...
  Widget build(BuildContext context) {
    Color tabColor = Theme.of(context).colorScheme.primaryContainer;
      ...
      child: SizedBox(
        ...
        child: Row(
          children: [
            ...
            if (GetPlatform.isWindows) const WindowsActionButtons(),
            if (GetPlatform.isLinux) const LinuxActionButtons(),
          ],
        ),
      ),
    );
